...
I used a similar process to get the type, searching for another specific class. While I also did this to get the number of bedrooms and bathrooms, I used regex to get the right data from a larger string. Retrieving a list of amenities from the page was more challenging and required a different approach. I created a separate function that converted the page HTML to a string, and used regex to retrieve this data.
